# ifndef YOLOV5_HEADERS_H
# define YOLOV5_HEADERS_H
# include<string>
# include<vector>
...
private:
    ...
    ncnn::Net* yolov5;
public:
    YoloV5Detector(std::string load_param_file=nullptr, std::string load_bin_file=nullptr);
    ~YoloV5Detector();
    int detect_objects(const cv::Mat& frame, std::vector<Object>& objects);
